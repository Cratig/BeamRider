...
public class SplashScene extends Scene {
	...
	public SplashScene() {
		...
		title1.registerEntityModifier(new MoveXModifier(2.0f, title1.getX(), activity.camera.getWidth() / 2 - title1.getWidth()));
		title2.registerEntityModifier(new MoveXModifier(2.0f, title2.getX(), activity.camera.getWidth() / 2));
		
		 
		
		title1.registerEntityModifier(new RotationAtModifier(2.0f, -37.0f, 0.0f, 0.0f, this.getRotationCenterY()));
		title2.registerEntityModifier(new RotationAtModifier(2.0f, 85.0f, 0.0f, 0.0f, this.getRotationCenterY()));
	}
